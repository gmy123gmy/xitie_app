...
Public.createStyleVidoHTML = function (style,tokenCode,isPraise) {
	...
	html += '<div class="con">'+style.styleContent+'</div>';
    	...
    	+'<div style="background:url('+fs+ style.videoLogo +');width:200px;margin-left:60px;background-size:cover" ><img src="'+ctx+'/static/img/play.png" width="33%" height="28%"  class="video" style="border: 1px solid #F8F8F8;margin-left:0" ></div>'
    	+'<div class="show_time">'
