...
Public.createStyleVidoHTML = function (style,tokenCode,isPraise) {
	var html = '<div class="article">'
    	...
    	html +='<img src="'+ctx+'/static/img/play.jpg" alt="" class="video"></div>';
    	html +='<div class="show_time">';
    	html +='<span class="time">'+style.showTime+'</span>'+'<span class="fa fa-thumbs-up parise" style="color:#E20500">'+style.praiseCount+'</span>';
		// if(isPraise){
